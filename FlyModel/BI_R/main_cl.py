...
def run(args, verbose=False):
    ...
    if args.pdf:
        ...
        all_accuracy = pd.DataFrame(precision_dict["all_tasks"])
        all_accuracy.to_csv(args.p_dir+str(args.experiment)+'_accuracy_all_tasks_seed_'+str(args.seed)+'.txt',header=False,index=False)
        print(precision_dict["all_tasks"])
